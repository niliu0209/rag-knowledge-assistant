...
使用流程：**提供商配置**页选择免费预设或填入自己的 Key → **文档上传**页上传 PDF/Word → **问答**页提问（支持连续对话）。
...
```bash
pytest          # 90 个用例：上传/删除补偿、迁移、加密、检索阈值、多轮历史、批量删除
```

## 隐私与安全说明

- **上传的文档内容会发送给你选择的 LLM API 提供商**（免费预设或 BYOK）；请勿上传敏感内容，上线公开部署前应补充明确的隐私告知
